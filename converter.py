...
def get_currency_name(code):
    names = {
        ...
        "BTC": "Биткойн", "ETH": "Эфириум", "KZT": "Казахстанский тенге",
        "BYN": "Белорусский рубль", "UAH": "Украинская гривна", "TRY": "Турецкая лира",
        "INR": "Индийская рупия", "BRL": "Бразильский реал", "KRW": "Южнокорейская вона",
